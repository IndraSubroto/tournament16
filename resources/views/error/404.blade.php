...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <meta name="description" content="Robust robust is super flexible, powerful, clean &amp; modern responsive bootstrap 4 robust template with unlimited possibilities.">
    <meta name="keywords" content="robust template, robust robust template, dashboard template, flat robust template, responsive robust template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Error 404 - Robust Free Bootstrap robust Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/robust/app-assets/css/pages/error.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page">
    ...
    <div class="card-header bg-transparent no-border pb-0">
        <h2 class="error-code text-xs-center mb-2 warning"><i class="icon-alert-circled"></i>404</h2>
        <h3 class="text-uppercase text-xs-center warning">Page Not Found !</h3>
    </div>
    <div class="card-body collapse in">
        <div class="row py-2">
            <div class="col-xs-12 col-sm-6 col-md-12">
                <a href="index.html" class="btn btn-primary btn-block font-small-3"><i class="icon-home4"></i> Back to Home</a>
            </div>
            </div>
        </div>
        <div class="card-footer bg-transparent pb-0">
            <div class="row">
                <p class="text-muted text-xs-center col-xs-12 py-1">© 2017 <a href="https://pixinvent.com/free-bootstrap-template/robust-lite/html/ltr/">Robust Lite </a>Crafted with <i class="icon-heart5 pink"> </i> by <a href="http://themeforest.net/user/pixinvent/portfolio" target="_blank">PIXINVENT</a></p>
