...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Error 403 - Access Denied/Forbidden!</title>
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page">
    ...
    <div class="card-header bg-transparent no-border pb-0">
        <h2 class="error-code text-xs-center mb-2 danger"><i class="icon-lock-combination"></i>403</h2>
        <h3 class="text-uppercase text-xs-center danger"> Access Denied/Forbidden !</h3>
    </div>
    <div class="card-body collapse in">
        <div class="row py-2">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <a href="{{ url('/') }}" class="btn btn-green btn-block font-small-3"><i class="icon-home3"></i> Back to Home</a>
            </div>
